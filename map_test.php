...
<div id="map">
Pilih Emisi:<br />
<form action="map_test.php" method="post">

<table>
<tr>
<td>
Jenis Emisi:<br />
<select name="jenis" id="jenis_data">
...
$('#jenis_data').change(function(){
	wmsLayer.getSource().updateParams({
		'viewparams': 'jenis:'+$('#jenis_data>option:selected').val()
	});
});

$('#id_data').change(function(){
	wmsLayer.getSource().updateParams({
		'viewparams': 'id_me:'+$('#id_data>option:selected').val()
	});
	wmsLayer.styles = 'ch4';
});
